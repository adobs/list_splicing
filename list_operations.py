...
def custom_append(input_list, value):
    ...
    end_index = custom_len(input_list)
    input_list[end_index:] = [value]
...
def custom_extend(input_list, second_list):
    ...
    """
    end_index = custom_len(input_list)
    input_list[end_index:] = second_list
...
def custom_reverse(input_list): 
    ...
    # input_list[custom_len(input_list):] = input_list[-1::-1]
    # input_list[:length] = []
    # print input_list
    # for i in range(custom_len(input_list)):
